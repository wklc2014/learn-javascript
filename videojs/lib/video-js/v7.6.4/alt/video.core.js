...
(function (global, factory) {
  ...
  var _keycode_2_2_0_keycode_1 = _keycode_2_2_0_keycode.code;
  var _keycode_2_2_0_keycode_2 = _keycode_2_2_0_keycode.codes;
  var _keycode_2_2_0_keycode_3 = _keycode_2_2_0_keycode.aliases;
  var _keycode_2_2_0_keycode_4 = _keycode_2_2_0_keycode.names;
  var _keycode_2_2_0_keycode_5 = _keycode_2_2_0_keycode.title;
  ...
  function (_Component) {
    ...
    _proto.handleKeyDown = function handleKeyDown(event) {
      ...
      if (_keycode_2_2_0_keycode.isEventKey(event, 'Escape') && this.closeable()) {
        event.preventDefault();
        this.close();
        return;
      ...
      if (!_keycode_2_2_0_keycode.isEventKey(event, 'Tab')) {
        return;
      }
  ...
  function initParams(uri, options, callback) {
    ...
    if (_isFunction_1_0_1_isFunction(options)) {
      callback = options;
  ...
  function (_Track) {
    ...
    function TextTrack(options) {
      ...
      if (settings.src) {
        ...
        loadTrack(settings.src, assertThisInitialized(_this));
      } else {
        _this.loaded_ = true;
      }
  ...
  function (_Component) {
    ...
    _proto.handleKeyDown = function handleKeyDown(event) {
      ...
      // Player hotkeys.
      if (_keycode_2_2_0_keycode.isEventKey(event, 'Space') || _keycode_2_2_0_keycode.isEventKey(event, 'Enter')) {
        event.preventDefault();
        event.stopPropagation();
        this.trigger('click');
      } else {
  ...
  function (_Button) {
    ...
    */
    ...
    _proto.handleKeyDown = function handleKeyDown(event) {
      ...
      if (_keycode_2_2_0_keycode.isEventKey(event, 'Esc')) {
        event.preventDefault();
        event.stopPropagation();
        this.trigger('click');
      } else {
  ...
  function (_Component) {
    ...
    */
    ...
    _proto.handleKeyDown = function handleKeyDown(event) {
      ...
      if (_keycode_2_2_0_keycode.isEventKey(event, 'Left') || _keycode_2_2_0_keycode.isEventKey(event, 'Down')) {
        event.preventDefault();
        event.stopPropagation();
        this.stepBack(); // Up and Right Arrows
      } else if (_keycode_2_2_0_keycode.isEventKey(event, 'Right') || _keycode_2_2_0_keycode.isEventKey(event, 'Up')) {
        event.preventDefault();
        event.stopPropagation();
        this.stepForward();
      } else {
  ...
  function (_Slider) {
    ...
    _proto.handleKeyDown = function handleKeyDown(event) {
      ...
      } else if (_keycode_2_2_0_keycode.isEventKey(event, 'Home')) {
        event.preventDefault();
        event.stopPropagation();
        this.player_.currentTime(0);
      } else if (_keycode_2_2_0_keycode.isEventKey(event, 'End')) {
        event.preventDefault();
        event.stopPropagation();
        this.player_.currentTime(this.player_.duration());
      } else if (/^[0-9]$/.test(_keycode_2_2_0_keycode(event))) {
        event.preventDefault();
        event.stopPropagation();
        var gotoFraction = (_keycode_2_2_0_keycode.codes[_keycode_2_2_0_keycode(event)] - _keycode_2_2_0_keycode.codes['0']) * 10.0 / 100.0;
        this.player_.currentTime(this.player_.duration() * gotoFraction);
      } else if (_keycode_2_2_0_keycode.isEventKey(event, 'PgDn')) {
        event.preventDefault();
        event.stopPropagation();
        this.player_.currentTime(this.player_.currentTime() - STEP_SECONDS * PAGE_KEY_MULTIPLIER);
      } else if (_keycode_2_2_0_keycode.isEventKey(event, 'PgUp')) {
        event.preventDefault();
        event.stopPropagation();
        this.player_.currentTime(this.player_.currentTime() + STEP_SECONDS * PAGE_KEY_MULTIPLIER);
      } else {
  ...
  function (_Component) {
    ...
    _proto.handleKeyDown = function handleKeyDown(event) {
      ...
      if (_keycode_2_2_0_keycode.isEventKey(event, 'Esc') || _keycode_2_2_0_keycode.isEventKey(event, 'Tab')) {
        if (this.buttonPressed_) {
          this.unpressButton();
      ...
      } else if (_keycode_2_2_0_keycode.isEventKey(event, 'Up') || _keycode_2_2_0_keycode.isEventKey(event, 'Down')) {
        if (!this.buttonPressed_) {
          event.preventDefault();
          this.pressButton();
        }
  ...
  function (_ClickableComponent) {
    ...
    _proto.handleKeyDown = function handleKeyDown(event) {
      if (!MenuKeys.some(function (key) {
        return _keycode_2_2_0_keycode.isEventKey(event, key);
      })) {
  ...
  function (_Component) {
    ...
    _proto.handleHotkeys = function handleHotkeys(event) {
      ...
      var _hotkeys$fullscreenKe = hotkeys.fullscreenKey,
        ...
        return _keycode_2_2_0_keycode.isEventKey(keydownEvent, 'f');
      } : _hotkeys$fullscreenKe,
          _hotkeys$muteKey = hotkeys.muteKey,
          muteKey = _hotkeys$muteKey === void 0 ? function (keydownEvent) {
        return _keycode_2_2_0_keycode.isEventKey(keydownEvent, 'm');
      } : _hotkeys$muteKey,
          _hotkeys$playPauseKey = hotkeys.playPauseKey,
          playPauseKey = _hotkeys$playPauseKey === void 0 ? function (keydownEvent) {
        return _keycode_2_2_0_keycode.isEventKey(keydownEvent, 'k') || _keycode_2_2_0_keycode.isEventKey(keydownEvent, 'Space');
